...
if __name__ == "__main__":
    ...
    full_length_pretraining_percentage = 0.9
    full_length = 512
    ...
    def create_shard(f_path, shard_idx, set_group, args):
        ...
        hdf5_preprocessing_cmd = "python data/create_pretraining_data_automodel.py"
        ...
        if args.custom_tokenizer is not None:
            hdf5_preprocessing_cmd += f" --custom_tokenizer={args.custom_tokenizer}"

        print(hdf5_preprocessing_cmd)
    ...
    for dup_idx in range(args.dup_factor):
        ...
        if dup_idx >= full_length_pretraining_percentage * args.dup_factor:
            args.max_seq_length = full_length
